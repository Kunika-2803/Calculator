		...
		<table class="calculator" cellspacing="0" cellpadding="1">
			<tr>
				<td><div class="dropdown">
  				<button class="dropbtn" id="btn1">Fahrenheit</button>
  				<div id="myDropdown" class="dropdown-content">
    				<a href="#" class="selector">Celsius</a>
    				<a href="#" class="selector">Fahrenheit</a>
    				<a href="#" class="selector">Kelvin</a>
  				</div>
				</div>
				</td>
			...
			<tr>
				<td><div class="dropdown">
  				<button class="dropbtn" id="btn2">Celsius</button>
				</div>
				</td>
