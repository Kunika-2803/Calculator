		...
		<table class="calculator" cellspacing="0" cellpadding="1">
			<tr>
				<td><div class="dropdown">
  				<button class="dropbtn" id="btn1">MB</button>
  				<div id="myDropdown" class="dropdown-content">
    				<a href="#" class="selector">B</a>
    				<a href="#" class="selector">KB</a>
    				<a href="#" class="selector">MB</a>
				<a href="#" class="selector">GB</a>
    				<a href="#" class="selector">TB</a>
    				<a href="#" class="selector">PB</a>
  				</div>
				</div>
				</td>
			...
			<tr>
				<td><div class="dropdown">
  				<button class="dropbtn" id="btn2">KB</button>
				</div>
				</td>
